...
########################################
  ...
  shapeFileLayer  ="Sardinie"    #User input
  ...
  gridFileLayer   ="TestGrid"    #User input
  ...
  my.radius.lambert  = 50000       #User input
...
if(All1 == TRUE || Script2 == TRUE) {
  ...
  numberOutbreakGeographicRegions <- 2  #User input
  namesArea <- list()  
  for(i in 1:numberOutbreakGeographicRegions){
      name1 <- paste("EEV_outbreakArea_", i, sep="")
